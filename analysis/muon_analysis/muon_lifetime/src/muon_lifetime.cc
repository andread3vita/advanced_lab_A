...
void FitData(std::string filename, int bin = 75)
{
    ...
    */
    ...
    c_chi->SetGrid();
    c_chi->SetLogz();
    TF2 *f_chi = new TF2("f_chi", chi_sqr, f->GetParameter(1) - 20 * f->GetParError(1),
                         f->GetParameter(1) + 20 * f->GetParError(1), f->GetParameter(2) - 20 * f->GetParError(2),
                         f->GetParameter(2) + 20 * f->GetParError(2), 1);
